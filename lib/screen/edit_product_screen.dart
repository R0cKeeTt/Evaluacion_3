import 'package:evaluacion_3/providers/providers.dart';
import 'package:evaluacion_3/services/services.dart';
import 'package:evaluacion_3/widgets/widgets.dart';
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            Stack(
              children: [
                ProductImage(url: productService.SelectProduct!.productImage),
                Positioned(
                  top: 40,
                  left: 20,
                  child: IconButton(
